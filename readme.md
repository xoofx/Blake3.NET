...
The new `Blake3.Managed` package delivers near-native BLAKE3 performance without shipping or loading
a native library. Benchmarks on an AMD Ryzen 9 9950X (x64) and an Apple M4 Pro (ARM64) show that:

- Serial `Blake3.Managed` performance ranges from about **7% faster to 30% slower** than the
